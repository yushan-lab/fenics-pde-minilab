...
The implementation targets FEniCSx / DOLFINx. On local Windows machines without a working DOLFINx or Docker setup, the GitHub Actions workflow provides the canonical cloud reproduction path.
...
The tables below summarize generated CSV outputs from the DOLFINx workflow. This is manufactured-solution verification for a small controlled PDE mini-project.
...
| --- | --- | --- | --- | --- | --- |
| P1 | 64 | 0.000338 | 0.05451 | 1.998 | 0.9993 |
| P2 | 64 | 1.075e-06 | 0.0005277 | 3 | 1.999 |

The Poisson rates are consistent with approximately second-order P1 L2 convergence, first-order P1 H1-seminorm convergence, third-order P2 L2 convergence, and second-order P2 H1-seminorm convergence.

Poisson sampled pointwise error check:

| Element | n | L2 error | sampled Linf error |
| --- | --- | --- | --- |
| P2 | 64 | 1.075e-06 | 3.696e-06 |

Heat Crank-Nicolson summary:

| n | Steps | Final-time L2 error | L2 rate |
| --- | --- | --- | --- |
| 8 | 20 | 0.007008 | n/a |
| 16 | 40 | 0.001815 | 1.949 |
| 32 | 80 | 0.0004579 | 1.987 |
| 64 | 160 | 0.0001147 | 1.997 |

The final-time L2 error decreased monotonically from 0.007008 to 0.0001147.

All numbers in this block are regenerated by `scripts/reproduce_all.py`.
<!-- GENERATED_RESULTS_END -->

Generated figures:

![Poisson convergence](figures/poisson_convergence.png)

![Poisson solution](figures/poisson_solution.png)

![Poisson pointwise error](figures/poisson_error.png)

![Heat error trend](figures/heat_error_trend.png)

![Heat initial condition](figures/heat_initial_condition.png)

![Heat final solution](figures/heat_final_solution.png)

![Heat final error](figures/heat_final_error.png)
